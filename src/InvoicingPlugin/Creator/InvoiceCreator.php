...
namespace Programari\SyliusPifactPlugin\InvoicingPlugin\Creator;
...
final class InvoiceCreator implements InvoiceCreatorInterface
{
    ...
    public function __invoke(string $orderNumber, \DateTimeInterface $dateTime): void
    {
        ...
        //TODO: cridar a la API per a crear la factura amb el json de $invoice
        $number = 'V' . $invoice->number();
        $issuedAt = $invoice->issuedAt();
        //TODO: Assignar el nou número i data de factura a $invoice
        $invoice->setNumber($number);
        $invoice->setIssuedAt($issuedAt);
        //TODO Assignar la URL del PDF a $invoice
